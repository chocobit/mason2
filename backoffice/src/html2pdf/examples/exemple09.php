...
If you would like to have any further information, please contact : 
ติดต่อสอบถามได้ที่ คุณสุนิศา หรือ คุณภาณิชา โทร.02-319-7677 ต่อ 103 และ 212 แฟกซ์ 02-316-5666 อีเมล์ : sunisa@tma.or.th, panicha@tma.or.th
...
<?php
    if ($generate) {
        ...
        try
        {
            ...
            $html2pdf->writeHTML('<page style="font-family:freeserif,"Helvetica Neue", Helvetica, Arial, sans-serif;width:100%;">'.$content.'</page>');
